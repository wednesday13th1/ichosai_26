...
export const WORLD_CONFIGS=Object.freeze({
  clock:{id:'01',title:'DOWN THE HOLE',density:.35,palette:{ivory:'#F2EBDD',grey:'#7A746C',ink:'#1E1C1A',blue:'#A6B7C2',silver:'#9B948A'},objects:[
  ...
  cards:{id:'02',title:"QUEEN'S COURT",density:.45,palette:{burgundy:'#4A0010',crimson:'#9A0A24',rose:'#C72E45',cherry:'#2A0A10',gold:'#B89A55',ivory:'#F2E9DE'},objects:[
  ...
  chess:{id:'03',title:'LOST IN TIME',density:.40,palette:{sepia:'#8A7052',bronze:'#9A7448',stone:'#77736B',ivory:'#EFE5D1',gold:'#B39355'},objects:[
  ...
  'tea-party':{id:'04',title:'MAD TEA PARTY',density:.41,palette:{cream:'#F6EFE4',dustyRose:'#D8A6AC',rose:'#C98793',sage:'#A9B29B',gold:'#C9AD76'},objects:[
